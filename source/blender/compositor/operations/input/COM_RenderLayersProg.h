...
<<<<<<< HEAD:source/blender/compositor/operations/input/COM_RenderLayersProg.h
=======

 private:
  ViewLayer *getViewLayer();
>>>>>>> upstream/compositor-up:source/blender/compositor/operations/COM_RenderLayersProg.h
};
